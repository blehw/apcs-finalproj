...
public class Route2 {
	...
	System.out.println("Do you want to WALK FORWARDS (to CERULEAN CITY) or WALK BACKWARDS (to PEWTER CITY)?");
	s = scan.nextLine();
	s = s.toLowerCase();
	if (s.equals("walk forwards")) {
		...
		ceruleancity.routine(player);
	    }
	    System.out.println("You are " + (1000 - meters) + " meters from CERULEAN CITY. You are " + meters + " meters from PEWTER CITY.");
	    int rand = r.nextInt(2);
	    if (rand == 0) {
		Rattata rattata = new Rattata();
		rattata.setLevel(8);
		rattata.setMaxHealth(20 + r.nextInt(10));
		rattata.setHealth(rattata.getMaxHealth());
		rattata.setMaxSpeed(20 + r.nextInt(10));
		rattata.setSpeed(rattata.getMaxSpeed());
		rattata.setMaxDefense(20 + r.nextInt(10));
		rattata.setDefense(rattata.getMaxDefense());
		rattata.setMaxAttack(20 + r.nextInt(10));
	...
	if (s.equals("walk backwards")) {
		...
		pewtercity.walk(player,"street");
	    }
	    System.out.println("You are " + meters + " meters from PEWTER CITY. You are " + (1000 -meters) + " meters from CERULEAN CITY.");
	...
	System.out.println("Do you want to WALK FORWARDS (to PEWTER CITY) or WALK BACKWARDS (to CERULEAN CITY)?");
	s = scan.nextLine();
	s = s.toLowerCase();
	if (s.equals("walk forwards")) {
	    meters =  meters + 100;
	    ...
	    System.out.println("You are " + (1000 - meters) + " meters from PEWTER CITY. You are " + meters + " meters from CERULEAN CITY.");
	    int rand = r.nextInt(4);
	    if (rand == 0) {
		Rattata rattata = new Rattata();
		rattata.setLevel(8);
	...
	if (s.equals("walk backwards")) {
	    ...
	    System.out.println("You are " + meters + " meters from CERULEAN CITY. You are " + (1000 -meters) + " meters from PEWTER CITY.");
	    int rand = r.nextInt(4);
	    if (rand == 0) {
		Rattata rattata = new Rattata();
	        rattata.setLevel(8);
